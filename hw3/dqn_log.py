...
def learn(
    ...
    locals_ = locals()
    params_to_log=['batch_size','frame_history_len','gamma','learning_freq','learning_starts','replay_buffer_size','target_update_freq']
    params = {k: locals_[k] if k in params_to_log else None for k in args}
    ...
    metrics_filename = os.path.join(logdir, "metrics.pkl")
    metrics = {
        "timestep": [],
        "mean_reward": [],
        "best_mean_reward": [],
    ...
    for t in itertools.count():
        ...
        if t % LOG_EVERY_N_STEPS == 0 and model_initialized:
            ...
            logz.log_tabular("mean_reward", mean_episode_reward)
            logz.log_tabular("best_mean_reward", best_mean_episode_reward)
